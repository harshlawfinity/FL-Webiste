...
const faqs = [
  ...
  },
  {
    ...
    answer: "The application may be rejected, and rectifications must be made.",
  },
  {
    question: "Can I get Fire NOC before the completion of construction?",
    answer: "A provisional NOC may be obtained in some cases",
  },
  {
    question: "Is it necessary to install specific equipment to get a Fire NOC?",
  ...
  },
  {
    ...
    answer: "This is a serious offense and may lead to penalties or sealing.",
  },
];
  ...
  return (
    <section id="faqs" className="bg-gradient-to-b from-[#f9f9ff] to-white py-16 px-6">
      <div className="max-w-5xl mx-auto">
        {/* Fire NOC Haryana FAQ heading */}
        <h2 className="text-3xl sm:text-4xl font-semibold text-center text-[#000000] mb-12">
          Frequently Asked Questions For Fire NOC in Haryana
        </h2>
