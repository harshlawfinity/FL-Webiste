        ...
        <div className="md:col-span-3 space-y-14">
          ...
          >
            ...
            <p className="text-justify">
              ...
              can help you obtain all the <a href="/factory-licence-in-haryana" className="text-blue-600 underline">Factory license</a> you need to set up and operate a factory in
              Haryana.
            </p>
          </Section>
